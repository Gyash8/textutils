...
export default function Navbar(props) {
  ...
  <input className="form-check-input" type="checkbox" onClick={props.redMode} role="switch" id="flexSwitchCheckDefault"/>
  <label className="form-check-label" htmlfor="flexSwitchCheckDefault">Red Mode</label>
</div>
      <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
  <input className="form-check-input" type="checkbox" onClick={props.blackMode} role="switch" id="flexSwitchCheckDefault"/>
